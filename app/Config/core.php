...
if (!function_exists('denv')) {
	...
	Configure::write('Collibra', [
		'community' => [
			...
			'virtualDatasets' => '169fac07-e960-4782-92ca-fead181c6e7d',
		...
		'workflow' => [
			...
			'updateVirtualTables' => '000d3f04-70e2-46e9-8777-ffbc363c1f9a',
		...
		'relationship' => [
			...
			'datasetToVirtualTable' => 'e6556e6a-4eb3-4bf2-a045-8f3a571cd18b',
			'schemaToTable' => '00000000-0000-0000-0000-000000007043',
			'columnToTable' => '00000000-0000-0000-0000-000000007042',
			'spaceToFolder' => '6909f005-43c8-4e36-869b-914209eadaf8',
			'folderToFolder' => 'f49c9630-06bf-40d9-a25b-3f41f63e7d3b',
			'folderToVirtualTable' => 'fc21da70-dddd-47a4-8cef-4d41f32e417d',
		...
		'type' => [
			...
			'dataset' => '00000000-0000-0000-0001-000400000001',
		...
		'policy' => [
			...
			'restrictedPolicy' => 'bb6588e5-0a6d-48de-a347-a087fc6e4350',
