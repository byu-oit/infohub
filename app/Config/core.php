...
if (!function_exists('denv')) {
	...
	Configure::write('Collibra', [
		...
		'relationship' => [
			...
			'DSRtoNecessaryVirtualDataset' => '1cf4ebdf-7594-42b5-b288-b4bd094ff821',
			...
			'folderToVirtualDataset' => 'fc21da70-dddd-47a4-8cef-4d41f32e417d',
			'spaceToVirtualDataset' => 'a4dcea9d-b222-452b-8af2-5c02590ba2df',
			'columnToVirtualDataset' => '39f5bacc-a0eb-4468-9f4e-9623b966e991',
