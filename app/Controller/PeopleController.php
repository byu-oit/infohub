...
class PeopleController extends AppController {
	...
	public function index(){
		...
		$resp = $this->CollibraAPI->get('term/f6b8b3cd-373c-43d7-8cbd-d8f03ff9048b');
		...
		$resp = $this->CollibraAPI->get('term/8ed41506-3eaf-47e1-b076-76bb49022059');
	...
	public function dept() {
		...
		$jsonResp1 = $this->CollibraAPI->get('term/f6b8b3cd-373c-43d7-8cbd-d8f03ff9048b');
		$stewardDefinition = json_decode($jsonResp1);
		$stewardDefinition = strip_tags($stewardDefinition->attributeReferences->attributeReference[3]->value);

		$jsonResp2 = $this->CollibraAPI->get('term/8ed41506-3eaf-47e1-b076-76bb49022059');
