...
class MyaccountController extends AppController {
	...
	public function index() {
		...
		$resp = $this->CollibraAPI->postJSON(
				'search',
				'{"query":"'.$personID.'", "filter": {"category": ["TE"], "vocabulary": ["b1ae53a6-46a1-4fdc-a4fb-5dcfcd9c61a1"] }, "fields": ["f1d5726a-32a2-47c4-b48c-d3be43880462"] }'
		);
		...
		$workflowResp = $this->CollibraAPI->get('workflow/'.Configure::read('Collibra.isaWorkflow').'/form/start');
