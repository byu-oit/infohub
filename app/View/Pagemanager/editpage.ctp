            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="2">
                        ...
                        <?php if($pgID==1){ ?>
                        <a href="/admin/pagemanager/addpage/<?php echo $pgID ?>"><img src="/img/admin/page_white_add.png" title="Add Subpage" border="0" /> Add Subpage</a>
                        <?php }?>
                        <?php if($pgID!=1){ ?>
                        <a href="/admin/pagemanager/deletepage/<?php echo $pgID ?>" onclick="return confirm('Are you sure you want to delete this page?')"><img src="/img/admin/delete.png" title="Delete Page" border="0" /> Delete Page</a>
                        <?php }?>
                        <div class="hr"></div>
                    </td>
                </tr>
