...
?>
		...
		<div class="data-col">
			<h5>Name:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Requester Name']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Phone Number:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Requester Phone']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Email:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Requester Email']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Role:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Requester Role']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Requesting Organization:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Requesting Organization']->value ?></p>
		</div>
		<div class="clear"></div>
		...
		<div class="data-col">
			<h5>Sponsor Name:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Sponsor Name']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Sponsor Role:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Sponsor Role']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Sponsor Email:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Sponsor Email']->value ?></p>
		</div>
		<div class="data-col">
			<h5>Sponsor Phone:</h5>
			<p><?php echo $request->attributeReferences->attributeReference['Sponsor Phone']->value ?></p>
		</div>
		<div class="clear"></div>

		<h3 class="headerTab">Application Name</h3>
		<div class="clear"></div>
		<p><?= $request->attributeReferences->attributeReference['Application Name']->value ?></p>
