...
?>
		<div id="term<?php echo $term->termrid; ?>" class="resultItem">
			...
			<form action="/request/index/<?php echo $term->termrid; ?>" method="post">
				...
				?>
				<input type="button" onclick="addToQueue(this, true)" data-title="<?php echo $termRequestTitle; ?>" data-rid="<?php echo $termRequestID ?>" data-vocabID="<?php echo $term->commrid ?>" api="false" class="requestAccess grow mainRequestBtn" value="Add To Request" />
				<?php
					}else{
				?>
