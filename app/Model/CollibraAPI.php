...
class CollibraAPI extends Model {
	...
	public function getAllCommunities() {
		//$json = $this->get('/rest/2.0/communities?offset=0&limit=0&nameMatchMode=ANYWHERE&parentId=d9f1c1bb-17cf-4fcb-9046-49d35f839623&excludeMeta=true&sortField=NAME&sortOrder=ASC',
		//					['json' => true]);
		$resp = $this->postJSON(
			'output/data_table',
